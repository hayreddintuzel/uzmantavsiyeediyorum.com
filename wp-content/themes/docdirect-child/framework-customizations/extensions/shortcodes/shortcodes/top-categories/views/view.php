			...
			<div class="col-md-4 col-sm-4 col-xs-6">
				<div class="doc-category">
					<figure class="doc-categoryimg">
						...
						<p>	<?php //url ye göre yönlendirme ?>
						 <a href="https://uzmantavsiyeediyorum.com/uzmanlik/<?php echo esc_attr( $dir->post_name );?>"><img src="<?php echo esc_url( $banner );?>"</a>
					<?php //search carousel e yönlendirme ?>
					<?php /*	   <a href="<?php echo esc_attr( $dir->post_name );?>"><img src="<?php echo esc_url( $banner );?>" alt="<?php echo esc_attr( $title );?>"></a></p> */ ?>
